...
function [MOG_RWaveTimes,IMOG,log,offsets,M]=MRM_MOG_ISPACE(ISpace,Times,PAR)
...
parfor iRR=1:length(PAR.MOG.RRrange)
...
if strcmp(PAR.PIPELINE.MOGPARAM, 'multi') && ~strcmp(PAR.PIPELINE.MOGPARAM, 'single')
