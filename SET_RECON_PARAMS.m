...
PAR.SaveInterMedRes = 1;                % saves intermediate (0: not saving, 1: mat files)
...
PAR.MOCORT.perform = 0;                 % status 1 to perform RT recons, status 0 does not perform RT recon
PAR.MOCORT.regperform = 0;              % status 1 to perform registration, status 0 does not perform registration
...
PAR.MOCORT.REGengine = 'inbuilt';       % 'inbuilt' uses imreg functions from Matlab Library. 'elastix' uses elastix modules and needs installation
